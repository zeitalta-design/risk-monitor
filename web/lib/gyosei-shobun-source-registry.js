...
const PREFECTURE_TAKKEN_SOURCES = [
  ...
  prefSource({ pref: "岐阜県", sector: "takken", id: "gifu_takken", name: "岐阜県 宅建業者監督処分（基準）", url: "https://www.pref.gifu.lg.jp/page/7544.html", discoveryStatus: "manual_review", notes: "第9バッチ再確認。処分基準PDFのみ。処分一覧の独自Web公表なし。建設はconfirmed。" }),
  ...
  prefSource({ pref: "三重県", sector: "takken", id: "mie_takken", name: "三重県 宅建業者監督処分（基準）", url: "https://www.pref.mie.lg.jp/GYOHSEI/000070979.htm", discoveryStatus: "manual_review", notes: "第9バッチ再確認。処分基準PDFのみ。一覧ページなし。MLITで補完。建設はconfirmed。" }),
  ...
  prefSource({ pref: "奈良県", sector: "takken", id: "nara_takken", name: "奈良県 宅建業者監督処分", url: null, discoveryStatus: "manual_review", notes: "第9バッチ再確認。新ドメインで処分公表ページ未特定。建設はconfirmed。" }),
  ...
  prefSource({ pref: "愛媛県", sector: "takken", id: "ehime_takken", name: "愛媛県 宅建業者監督処分（基準）", url: "https://www.pref.ehime.jp/page/2119.html", discoveryStatus: "manual_review", notes: "第9バッチ再確認。処分基準ページ。処分一覧なし。建設はcandidate。" }),
...
const PREFECTURE_KENSETSU_SOURCES = [
  ...
  prefSource({ pref: "茨城県", sector: "kensetsu", id: "ibaraki_kensetsu", name: "茨城県 建設業者監督処分", url: null, discoveryStatus: "manual_review", notes: "第9バッチ再確認。処分一覧の県独自Web公表ページ未発見。宅建はconfirmed。" }),
  ...
  prefSource({ pref: "鳥取県", sector: "kensetsu", id: "tottori_kensetsu", name: "鳥取県 建設業者監督処分", url: null, discoveryStatus: "manual_review", notes: "第9バッチ再確認。処分一覧ページ未発見。MLIT誘導。宅建はconfirmed。" }),
