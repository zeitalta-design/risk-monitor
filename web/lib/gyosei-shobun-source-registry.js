...
const ARCHITECT_OFFICE_SOURCES = [
  ...
  },
  {
    ...
    acquisitionMethod: "html",
    active: true,
    notes: "常設一覧ページではなく個別press releaseページのみ確認。平成27年度処分事例あり。継続性要確認のためcandidate。",
  },
  {
  ...
  },
  {
    ...
    discoveryStatus: "manual_review",
    expectedCoverage: "mlit_primary",
    complements: "新潟県の建築士事務所監督処分基準ページ。処分一覧の常設ページは未発見。",
    publicationWindow: "unknown",
    updateFrequency: "as_needed",
    acquisitionMethod: "html",
    active: true,
  ...
  },
  {
    ...
    acquisitionMethod: "html",
    active: true,
    notes: "将来再確認。処分ページURL確認済みだが内容は連絡先のみ。",
  },
  {
...
const SANPAI_CENTRAL_SOURCES = [
  ...
  },
  {
    ...
    authorityName: "愛知県",
    prefecture: "愛知県",
    sourceName: "愛知県 産業廃棄物処理業者への行政処分（プレスリリース）",
    url: "https://www.pref.aichi.jp/soshiki/list7-25.html",
    sourceType: "official_list",
    coverageScope: "partial",
    discoveryStatus: "candidate",
    expectedCoverage: "sanpainet_primary",
    complements: "愛知県による産業廃棄物処理業者への行政処分情報（プレスリリース形式）。一覧ページは未確認。",
    publicationWindow: "5 years",
    updateFrequency: "as_needed",
    acquisitionMethod: "html",
    active: true,
    notes: "個別プレスリリース（2025kansi03等）形式での公表のみ確認。一覧ページ未発見のためcandidate。",
  },
  {
    id: "hyogo_sanpai",
    sector: "sanpai",
    ...
    url: "https://web.pref.hyogo.lg.jp/tnk11/20250627haiki.html",
    sourceType: "official_list",
    coverageScope: "partial",
    discoveryStatus: "candidate",
    expectedCoverage: "sanpainet_primary",
    complements: "兵庫県による廃棄物処理法に基づく行政処分情報（プレスリリース形式）。一覧ページは未確認。",
    publicationWindow: "5 years",
    updateFrequency: "as_needed",
    acquisitionMethod: "html",
    active: true,
    notes: "個別プレスリリース形式での公表のみ確認。一覧ページ未発見のためcandidate。",
  },
  ...
  prefSource({ pref: "鳥取県", sector: "sanpai", id: "tottori_sanpai", name: "鳥取県 廃棄物処理業者への行政処分", url: "https://www.pref.tottori.lg.jp/dd.aspx?menuid=60760", discoveryStatus: "candidate", expectedCoverage: "hybrid", notes: "鳥取県生活環境部循環型社会推進課管轄。廃棄物処理業者への行政処分情報。個別公表形式のためcandidate。" }),
