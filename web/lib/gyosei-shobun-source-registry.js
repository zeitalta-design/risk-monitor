...
const PREFECTURE_TAKKEN_SOURCES = [
  ...
  prefSource({ pref: "岐阜県", sector: "takken", id: "gifu_takken", name: "岐阜県 宅建業者監督処分", url: "https://www.pref.gifu.lg.jp/page/625.html", discoveryStatus: "manual_review", notes: "宅建業法ポータルあり。処分一覧の独自公表は未確認。" }),
