...
const PREFECTURE_TAKKEN_SOURCES = [
  ...
  prefSource({ pref: "山形県", sector: "takken", id: "yamagata_takken", name: "山形県 宅建業者監督処分", url: "https://www.pref.yamagata.jp/180025/kurashi/sumai/kenchiku/takken.html", discoveryStatus: "manual_review", notes: "第13バッチ確認済み。宅建業ポータルに処分基準PDFとMLIT誘導あるが専用処分ページなし。県独自の一覧・個別公表も未発見でmanual_review維持。建設はcandidate。" }),
  ...
  prefSource({ pref: "山梨県", sector: "takken", id: "yamanashi_takken", name: "山梨県 宅建業者監督処分", url: "https://www.pref.yamanashi.jp/kenchikujutaku/takkengyou/kantokushobun.html", discoveryStatus: "candidate", notes: "再確認候補寄り。専用処分ページ（処分基準PDF+MLIT誘導）を確認済み。県独自の処分実績一覧はなくconfirmed不可だが、専用ページが存在するため将来の公表拡充時に再確認価値あり。", expectedCoverage: "mlit_primary" }),
  ...
  prefSource({ pref: "三重県", sector: "takken", id: "mie_takken", name: "三重県 宅建業者監督処分（基準）", url: "https://www.pref.mie.lg.jp/GYOHSEI/000070979.htm", discoveryStatus: "manual_review", notes: "第14バッチ確認済み。処分基準PDFのみで県独自一覧・個別公表なし。建設側TOPICS形式のpress releaseも宅建では未発見。MLITで補完。建設はconfirmed。" }),
...
const PREFECTURE_KENSETSU_SOURCES = [
  ...
  prefSource({ pref: "富山県", sector: "kensetsu", id: "toyama_kensetsu", name: "富山県 建設業者監督処分", url: "https://www.pref.toyama.jp/1510/sangyou/shoukoukensetsu/kensetsugyou/kj00001813/kj00001813-004-01.html", discoveryStatus: "candidate", sourceType: "press_release_only", notes: "再確認候補寄り。情報ページ+閲覧制度（5年分）あり。個別press release（R7営業停止2件）を確認済み。一覧ページはなく個別公表のみのためconfirmed不可だが、閲覧制度と公表実績があり再確認価値あり。", expectedCoverage: "hybrid" }),
  prefSource({ pref: "石川県", sector: "kensetsu", id: "ishikawa_kensetsu", name: "石川県 建設業者監督処分", url: "https://www.pref.ishikawa.lg.jp/kanri/kyokashinsei/houreizyunsyu.html", discoveryStatus: "candidate", sourceType: "press_release_only", notes: "再確認候補寄り。法令遵守ページに処分基準あり。個別press release（R6許可取消、R7営業停止）を確認済み。一覧ページはなく個別公表のみのためconfirmed不可だが、複数年の実績があり再確認価値あり。", expectedCoverage: "hybrid" }),
  prefSource({ pref: "福井県", sector: "kensetsu", id: "fukui_kensetsu", name: "福井県 建設業者監督処分（基準）", url: "https://www.pref.fukui.lg.jp/doc/kanri/kantokusyobun.html", discoveryStatus: "manual_review", notes: "第14バッチ確認済み。処分基準のみ。指名停止は別カテゴリ。press releaseアーカイブも404。県独自の建設業法監督処分一覧なし。宅建はconfirmed。" }),
  prefSource({ pref: "山梨県", sector: "kensetsu", id: "yamanashi_kensetsu", name: "山梨県 建設業者監督処分", url: "https://www.pref.yamanashi.jp/kentai/kantoku.html", discoveryStatus: "candidate", notes: "再確認候補寄り。専用処分ページ（処分基準PDF+5年間閲覧制度明記）を確認済み。県庁窓口で処分簿5年分閲覧可。県独自のWeb一覧はなくconfirmed不可だが、閲覧制度が明確なため将来の公表拡充時に再確認価値あり。", expectedCoverage: "mlit_primary" }),
  ...
  prefSource({ pref: "和歌山県", sector: "kensetsu", id: "wakayama_kensetsu", name: "和歌山県 建設業者監督処分（基準）", url: "https://www.pref.wakayama.lg.jp/prefg/081100/kghsyobun/index.html", discoveryStatus: "manual_review", notes: "第14バッチ確認済み。処分基準のみ。宅建側のsyobun.htmlに相当する建設ページなし。指名停止は別カテゴリ。県独自の建設業法監督処分一覧なし。宅建はconfirmed。" }),
  ...
  prefSource({ pref: "宮崎県", sector: "kensetsu", id: "miyazaki_kensetsu", name: "宮崎県 建設業者監督処分", url: "https://www.pref.miyazaki.lg.jp/kanri/shigoto/kokyojigyo/kantokushobun.html", discoveryStatus: "manual_review", notes: "第14バッチ確認済み。制度説明・処分基準PDFのみ。処分実績の掲載なし。入札停止は別カテゴリ。県独自の建設業法監督処分一覧なし。宅建はcandidate。" }),
