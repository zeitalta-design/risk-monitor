...
const PREFECTURE_TAKKEN_SOURCES = [
  ...
  prefSource({ pref: "岐阜県", sector: "takken", id: "gifu_takken", name: "岐阜県 宅建業者監督処分", url: "https://www.pref.gifu.lg.jp/page/625.html", discoveryStatus: "manual_review", notes: "宅建業法ポータル。処分一覧の独自Web公表は未確認。建設は confirmed 済み。" }),
  ...
  prefSource({ pref: "奈良県", sector: "takken", id: "nara_takken", name: "奈良県 宅建業者監督処分", url: null, discoveryStatus: "manual_review", notes: "旧URL（pref.nara.jp）はリダイレクト。新ドメイン（pref.nara.lg.jp）で処分公表ページ未特定。" }),
...
const PREFECTURE_KENSETSU_SOURCES = [
  ...
  prefSource({ pref: "沖縄県", sector: "kensetsu", id: "okinawa_kensetsu", name: "沖縄県 建設業者監督処分（基準）", url: "https://www.pref.okinawa.jp/machizukuri/kenchiku/1023167/1013358/1028170.html", discoveryStatus: "manual_review", notes: "処分基準ページ。処分一覧の独自Web公表は未確認。" }),
];
